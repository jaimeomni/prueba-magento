<?php
namespace OmniPro\BlogNoRequire\Model;

use OmniPro\BlogNoRequire\Api\Data\BlogInterface;
use OmniPro\BlogNoRequire\Api\Data\BlogSearchResultInterface;
use \OmniPro\BlogNoRequire\Model\ResourceModel\Blog\Collection;
use Magento\Framework\Api\SearchCriteriaInterface;
use Magento\Framework\Api\SortOrder;
use Magento\Framework\Exception\NoSuchEntityException;

class BlogRepository implements \OmniPro\BlogNoRequire\Api\BlogRepositoryInterface
{
    ...
    public function __construct(
        \OmniPro\BlogNoRequire\Api\Data\BlogInterfaceFactory $blogInterfaceFactory,
        \OmniPro\BlogNoRequire\Model\ResourceModel\Blog\CollectionFactory $blogCollectionFactory,
        \OmniPro\BlogNoRequire\Api\Data\BlogSearchResultInterfaceFactory $blogSearchResultInterfaceFactory
    )
    {
